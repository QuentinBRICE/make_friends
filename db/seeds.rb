...
advertisement = Advertisement.create(title: 'sortie entre amis', description: "détente avec des gens biens", price: 15, address: "15 Bd des Italiens, 75002 Paris")
...
advertisement = Advertisement.create(title: 'bowling entre amis', description: "détente avec des gens biens", price: 20, address: "5 Bd des Italiens, 75002 Paris")
advertisement.user = User.all.sample
advertisement.photo.attach(
